...
import t20220049.sw_vision.arm_controller.uitls.ColorUtil;

/**
 * 动画方式实现5.0风格的圆形进度条<br/>
 * 自定义选项多，更加流畅
 */
public class CircularProgressView extends View {
    ...
    private void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        currentProgress = a.getFloat(
                R.styleable.CircularProgressView_cpv_progress, 0f);
        maxProgress = a.getFloat(
                R.styleable.CircularProgressView_cpv_maxProgress, 100f);
        thickness = a.getDimensionPixelSize(
                R.styleable.CircularProgressView_cpv_thickness, 4);
        isIndeterminate = a.getBoolean(
                R.styleable.CircularProgressView_cpv_indeterminate, false);
        autoStartAnimation = a.getBoolean(
                R.styleable.CircularProgressView_cpv_animAutostart, true);
        color = a.getColor(R.styleable.CircularProgressView_cpv_color,
                ColorUtil.getPrimaryColor(getContext()));
        animDuration = a.getInteger(
                R.styleable.CircularProgressView_cpv_animDuration, 4000);
        animSteps = a.getInteger(
                R.styleable.CircularProgressView_cpv_animSteps, 3);
        a.recycle();
    }
