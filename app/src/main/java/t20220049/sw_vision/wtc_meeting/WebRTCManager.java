...
public class WebRTCManager implements ISignalingEvents {
    ...
    private t20220049.sw_vision.wtc_meeting.PeerConnectionHelper _peerHelper;
    ...
    public void connect(int mediaType, String roomId) {
        if (_webSocket == null) {
            ...
            _peerHelper = new t20220049.sw_vision.wtc_meeting.PeerConnectionHelper(_webSocket, _iceServers);
        } else {
            // 正在通话中
            _webSocket.close();
            _webSocket = null;
    ...
    public void setCallback(t20220049.sw_vision.wtc_meeting.IViewCallback callback) {
        if (_peerHelper != null) {
